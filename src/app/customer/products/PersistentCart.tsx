        ...
        <>
          <div style={{
            ...
            {Object.entries(quantities).map(([type, quantity]) => {
              ...
              const savings = (((retailPrices[batteryType] ?? 0) - (batterySpecs[batteryType]?.basePrice ?? 0)) / (retailPrices[batteryType] ?? 1)) * 100;
                ...
                <div key={type} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      ${((retailPrices[batteryType] ?? 0) * quantity).toFixed(2)}
                    </div>
                  </div>
                </div>
              );
