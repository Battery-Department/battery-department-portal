  ...
  return (
    <div className="runtime-calculator">
                    ...
                    recommendationElement.innerHTML = `
                      <div class="p-4 bg-white rounded-lg border border-blue-200 mt-4">
                        <div class="text-sm font-medium text-blue-800 mb-2">
                          We recommend the following for ${hoursNeeded} hours of ${selectedToolObj?.name || 'tool'} use:
                        </div>
      ...
      <div className="tool-runtime-cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        {runtimeData.tools.map(tool => {
          const sixAhRuntime = calculateRuntime(runtimeData.batteries["6Ah"] || 0, tool.consumption);
          const nineAhRuntime = calculateRuntime(runtimeData.batteries["9Ah"] || 0, tool.consumption); 
          const fifteenAhRuntime = calculateRuntime(runtimeData.batteries["15Ah"] || 0, tool.consumption);
          const isSelected = selectedTool === tool.id;
