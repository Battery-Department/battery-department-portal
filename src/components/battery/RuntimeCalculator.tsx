      ...
      <div style={{ marginTop: '32px' }}>
        ...
        <div style={{
          ...
          {runtimeData.tools.map(tool => {
            ...
            const sixAhRuntime = (runtimeData?.batteries?.["6Ah"] || 0) / tool.consumption;
            const nineAhRuntime = (runtimeData?.batteries?.["9Ah"] || 0) / tool.consumption;
            const fifteenAhRuntime = (runtimeData?.batteries?.["15Ah"] || 0) / tool.consumption;
